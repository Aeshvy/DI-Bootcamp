...
SELECT film_id, title, description, release_year FROM film ORDER BY rental_rate;
...
SELECT film_id, title, description, length, rental_rate FROM film WHERE title='Carol Texas';
